...
document.querySelector('#googleLogin').onclick = () => googleLogin('admin'); document.querySelector('#registerLogin').onclick = () => googleLogin('register'); document.querySelector('#clientLogin').onclick = () => googleLogin('client'); document.querySelector('#demoLogin').onclick = openDemo; document.querySelector('#authDismiss').onclick = openDemo; userMenu.querySelector('button').onclick = () => signOut(auth);
